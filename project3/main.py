...
if __name__ == '__main__':
    ...
    print("\n2-f25\n")
    data = parse.Parsing("2-f25.txt")
    print("FC")
    start = time.time()
    fc_result, constraint_checks, visited_nodes = csp.backtracking_search(data, select_unassigned_variable=csp.dom_wdeg,
    ...
    print("\nMAC")
    start = time.time()
    mac_result, constraint_checks, visited_nodes = csp.backtracking_search(data,
    ...
    print("\n7-w1-f4\n")
    data = parse.Parsing("7-w1-f4.txt")
    print("FC")
    start = time.time()
    fc_result, constraint_checks, visited_nodes = csp.backtracking_search(data, select_unassigned_variable=csp.dom_wdeg,
                                                                          inference=csp.forward_checking)
    ...
    print("\n7-w1-f5\n")
    data = parse.Parsing("7-w1-f5.txt")
    print("FC")
    start = time.time()
    fc_result, constraint_checks, visited_nodes = csp.backtracking_search(data, select_unassigned_variable=csp.dom_wdeg,
                                                                          inference=csp.forward_checking)
