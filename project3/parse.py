...
class Parsing(csp.CSP):
    ...
    def __init__(self, file_name):
        ...
        variables_domain = []
        f = open("rlfap/rlfap/var" + file_name, "r")
        ...
        domains_values = []
        f = open("rlfap/rlfap/dom" + file_name, "r")
        # Ignore the first line which is the amount of the records that follow
        ...
        f = open("rlfap/rlfap/ctr" + file_name, "r")
        # Ignore the first line which is the amount of the records that follow
        ...
        for line in f:
            ...
            self.constraints_splitted.append(value)
        f.close()
